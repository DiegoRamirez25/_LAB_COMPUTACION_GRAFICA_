...
// Properties
const GLuint WIDTH = 2200, HEIGHT = 1800;
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Carga de modelos y camara sintetica | Diego Ramirez | 319296738", nullptr, nullptr);
